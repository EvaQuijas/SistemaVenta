...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class AccesoController : Controller
    {
        ...
        public async Task<IActionResult> Login(VMUsuarioLogin modelo)
        {
            ...
            Usuario usuario_encontrado = await _usuarioServicio.ObtenerPorCrendenciales(modelo.Correo, modelo.Clave);
        ...
        public async Task<IActionResult> ReestablecerClave(VMUsuarioLogin modelo)
        {
            try
            {
                ...
                {
                    ViewData["MensajeError"] = "Tenemos problemas. Por favor inténtelo de nuevo máas tarde.";
                    ViewData["Mensaje"] = null;
                }
            }
            catch(Exception ex)
