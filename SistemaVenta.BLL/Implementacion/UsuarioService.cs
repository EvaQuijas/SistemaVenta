...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Editar(Usuario entidad, Stream Foto = null, string NombreFoto = "")
        {
            ...
            if (usuario_existe != null)
            {
                ...
                try
                {
                    ...
                    if (!respuesta)
                    {
                        throw new TaskCanceledException("No se pudo modificar");
                    }
        ...
        public async Task<Usuario> ObtenerPorCrendenciales(string correo, string clave)
        {
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (!correo_enviado)
                {
                    throw new TaskCanceledException("Intentalo de nuevo más tarde");
                }
                bool respuesta = await _repositorio.Editar(usuario_encontrado);
